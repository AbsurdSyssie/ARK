...
temp <- abx_per_indication %>% select(c(Name_1,Route_1,Prescription.start_1, Prescription.end_1, Decision_1, Decision_2, Name_2, Route_2, Prescription.start_2,Prescription.end_2,interval_1))

#what happened after the initial prescription

abx_per_indication <- abx_per_indication %>% 
  mutate(Decision_2 = case_when(
        Route_1 == Route_2 & Name_1 == Name_2 & Dose_1 == Dose_2 & Frequency_1 == Frequency_2  ~ paste0(Route_2, " ", Name_2,  "continued"),    
