...
#make all UTIs display as Urinary Tract Infection
  ...
  #make any blank indications "Unkown"
  ...
  Clean_Data$Reason.given <- sub("CLOSTRIDIUM DIFFICILE*", "CLOSTRIDIUM DIFFICILE", Clean_Data$Reason.given)
  
  Clean_Data$Reason.given <- gsub("C.DIFFICLE", "CLOSTRIDIUM DIFFICILE", Clean_Data$Reason.given)
  
  Clean_Data$Reason.given <- sub("C.DIFF", "CLOSTRIDIUM DIFFICILE", Clean_Data$Reason.given)
...
abx_per_indication <- abx_per_indication %>% 
  mutate(Decision_3 = case_when(Route_3 =="Intravenous" & Route_4 =="Oral" ~ 'IV to Oral Switch',
                                ...
                                Decision_2 == "Stopped as Oral within 72 hours" | Decision_2 == "Stopped as IV within 72 hours" | Decision_2 == "Stopped as Oral beyond 72 hours" | Decision_2 == "Stopped as IV beyond 72 hours" | Decision_2 =="" ~ (""),
                                TRUE ~ 'something else'
  ))
```
